...
// 9 departures (3 per trip) — placeholder scheduling data pending a real
// booking calendar from the client (Sep 2026 client itinerary revision).
...
export const departures: Departure[] = [
  ...
  { id: 'SFD-2609-SF3', trip: 'four-days-aboard-sea-familia', boat: 'sea-familia', start: '2026-09-19', nights: 3, cabinsLeft: 3, price: 1250, status: 'open', deposit: 0.25 },
  ...
  { id: 'SFD-2610-SF3', trip: 'four-days-aboard-sea-familia', boat: 'sea-familia', start: '2026-10-24', nights: 3, cabinsLeft: 2, price: 1250, status: 'limited', deposit: 0.25 },
  ...
  { id: 'SFD-2611-SF3', trip: 'four-days-aboard-sea-familia', boat: 'sea-familia', start: '2026-11-14', nights: 3, cabinsLeft: 4, price: 1250, status: 'open', deposit: 0.25 },
];
