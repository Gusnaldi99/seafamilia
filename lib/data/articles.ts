...
export const articles: Article[] = [
  {
    ...
    author: 'Ayu Prasetya',
    role: 'Cruise director, Familia Satu',
    date: '2026-06-18',
    read: 8,
    ph: 'deep',
    featured: true,
  ...
  {
    slug: 'eleven-years-at-one-loom',
    title: 'Eleven Years at One Loom',
    category: 'Places',
